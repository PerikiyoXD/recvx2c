...
void njGetMatrix(register NJS_MATRIX* pMatrix) {
    asm volatile (
        .set noreorder
        lw         $v1, pNaMatMatrixStuckPtr; // Line 1056, Address: 0x2d6a80, Func Offset: 0
        nop;
        ...
        lqc2       $vf4, 0x0($v1); // Line 1087, Address: 0x2d6a8c, Func Offset: 0xc
        lqc2       $vf5, 0x10($v1); // Line 1088, Address: 0x2d6a90, Func Offset: 0x10
        lqc2       $vf6, 0x20($v1); // Line 1089, Address: 0x2d6a94, Func Offset: 0x14
        lqc2       $vf7, 0x30($v1); // Line 1090, Address: 0x2d6a98, Func Offset: 0x18
        sqc2       $vf4, 0x0($pMatrix); // Line 1091, Address: 0x2d6a9c, Func Offset: 0x1c
        sqc2       $vf5, 0x10($pMatrix); // Line 1092, Address: 0x2d6aa0, Func Offset: 0x20
        sqc2       $vf6, 0x20($pMatrix); // Line 1093, Address: 0x2d6aa4, Func Offset: 0x24
        sqc2       $vf7, 0x30($pMatrix); // Line 1094, Address: 0x2d6aa8, Func Offset: 0x28





        jr      ra; // Line 1100, Address: 0x2d6aac, Func Offset: 0x2c
        nop;
    );
}
