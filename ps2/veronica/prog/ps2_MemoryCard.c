...
int ExecuteMemoryCardUnFormat(MEMORYCARDSTATE* pCard) { // Line 704, Address: 0x273d50, Func Offset: 0
    ...
    switch (pCard->ulMcSubState) // Line 707, Address: 0x273d5c, Func Offset: 0xc
    {
        ...
        case 0:
            lResult = MemoryCardUnFormat(pCard); // Line 711, Address: 0x273d7c, Func Offset: 0x2c
...
/* 100% match */
int ExecuteMemoryCardDelete(MEMORYCARDSTATE* pCard) { // Line 775, Address: 0x273e50, Func Offset: 0
    int lCmd, lResult;

    switch (pCard->ulMcSubState) // Line 778, Address: 0x273e5c, Func Offset: 0xc
    {
        case 0:
            lResult = DeleteMemoryCard(pCard); // Line 781, Address: 0x273e7c, Func Offset: 0x2c
            if (lResult != 0) // Line 782, Address: 0x273e88, Func Offset: 0x38
            {

                if (--pCard->cRetryCount != 0) // Line 785, Address: 0x273e94, Func Offset: 0x44
                {
                    return 0; // Line 787, Address: 0x273eb0, Func Offset: 0x60
                }
                else
                {
                    pCard->ulState = 0; // Line 791, Address: 0x273ebc, Func Offset: 0x6c
                    pCard->ulError = 7; // Line 792, Address: 0x273eb8, Func Offset: 0x68
                    pCard->cRetryCount = 5; // Line 793, Address: 0x273ec4, Func Offset: 0x74
                    return -1; // Line 794, Address: 0x273ecc, Func Offset: 0x7c
                }
            }


            pCard->ulMcSubState = 1; // Line 799, Address: 0x273ed4, Func Offset: 0x84
            pCard->cRetryCount = 5; // Line 800, Address: 0x273edc, Func Offset: 0x8c

            break; // Line 802, Address: 0x273ee0, Func Offset: 0x90

        case 1:
            if (sceMcSync(1, &lCmd, &lResult) == 1) // Line 805, Address: 0x273ee8, Func Offset: 0x98
            {
                if (lResult < 0) // Line 807, Address: 0x273f04, Func Offset: 0xb4
                {

                    pCard->ulState = 0; // Line 810, Address: 0x273f14, Func Offset: 0xc4

                    pCard->ulError = 7;  // Line 812, Address: 0x273f10, Func Offset: 0xc0
                    return -1; // Line 813, Address: 0x273f1c, Func Offset: 0xcc
                }



                pCard->ulState = 0xF; // Line 818, Address: 0x273f28, Func Offset: 0xd8
                pCard->ulError = 0;
                return 1; // Line 820, Address: 0x273f24, Func Offset: 0xd4
            }
    }


    return 0; // Line 825, Address: 0x273f38, Func Offset: 0xe8
...
/* 100% match */
int RecoveryMemoryCardWriteEnd(MEMORYCARDSTATE* pCard) {  // Line 1366, Address: 0x274230, Func Offset: 0

    if (pCard->ulState != 0xA)  // Line 1368, Address: 0x274238, Func Offset: 0x8
    {
        
        if(GetMemoryCardError(pCard) == 0)
        {

            return 0; // Line 1374, Address: 0x274248, Func Offset: 0x18
    ...
    pCard->ulState = 0; // Line 1385, Address: 0x274268, Func Offset: 0x38


    return 1; // Line 1388, Address: 0x274264, Func Offset: 0x34
...
int FormatMemoryCard(MEMORYCARDSTATE* pCard) { 
    ...
    if (pCard->ulState != 0)  // Line 1407, Address: 0x274280, Func Offset: 0
    {

        return 0; // Line 1410, Address: 0x27428c, Func Offset: 0xc

    }

    pCard->ulState = 4; // Line 1414, Address: 0x274294, Func Offset: 0x14

    pCard->ulMcSubState = 0; // Line 1416, Address: 0x2742a0, Func Offset: 0x20

    return 1; // Line 1418, Address: 0x27429c, Func Offset: 0x1c
...
/* 100% match */
int RecoveryMemoryCardFormatEnd(MEMORYCARDSTATE* pCard) { // Line 1435, Address: 0x2742b0, Func Offset: 0
    
    if (pCard->ulState != 0xC)  // Line 1437, Address: 0x2742b8, Func Offset: 0x8
    {    
        if(GetMemoryCardError(pCard) == 0)
        {
            return 0; // Line 1441, Address: 0x2742c8, Func Offset: 0x18
        }
        else
        {
            return -1;
    ...
    pCard->ulState = 0; // Line 1450, Address: 0x2742e8, Func Offset: 0x38

    
    return 1; // Line 1453, Address: 0x2742e4, Func Offset: 0x34
...
/* 100% match */
int GetMcSelectPortType(MEMORYCARDSTATE* pCard, unsigned int ulPort) { // Line 1644, Address: 0x274300, Func Offset: 0
    
    int lResult;

    if (pCard->ulState != 0)  // Line 1648, Address: 0x274314, Func Offset: 0x14
    {

        return 0; // Line 1651, Address: 0x274324, Func Offset: 0x24

    }
    lResult = CheckMcSelectPortInfoType(ulPort); // Line 1654, Address: 0x27432c, Func Offset: 0x2c


    if (lResult > 0) // Line 1657, Address: 0x274338, Func Offset: 0x38
    { 

        SetMemoryCardSelectPortState(pCard, ulPort, lResult); // Line 1660, Address: 0x274340, Func Offset: 0x40
        
        return lResult; // Line 1662, Address: 0x274350, Func Offset: 0x50
    }
    if (lResult <= 0)  // Line 1664, Address: 0x274358, Func Offset: 0x58
    { 

        SetMemoryCardSelectPortState(pCard, ulPort, 0U); // Line 1667, Address: 0x274360, Func Offset: 0x60
        
        return 4; // Line 1669, Address: 0x274370, Func Offset: 0x70
    }



    return -1; // Line 1674, Address: 0x274378, Func Offset: 0x78
...
/* 100% match */
int CheckMemoryCardChangeConnectTypeAll(MEMORYCARDSTATE* pCard) { // Line 1750, Address: 0x2743a0, Func Offset: 0
    int lPort1Result, lPort0Result;

    
    if (pCard->ulState != 0) // Line 1754, Address: 0x2743b4, Func Offset: 0x14
    {
        return 0; // Line 1756, Address: 0x2743c0, Func Offset: 0x20
    }

    if (pCard->cMcCheckFlag == 0) // Line 1759, Address: 0x2743c8, Func Offset: 0x28
    {

        
        SaveMemoryCardSelectPortState(pCard, 0U); // Line 1763, Address: 0x2743d4, Func Offset: 0x34
        
        lPort0Result =  CheckMcSelectPortInfoType(0U); // Line 1765, Address: 0x2743dc, Func Offset: 0x3c
        
        SetMemoryCardSelectPortState(pCard, 0U, lPort0Result); // Line 1767, Address: 0x2743e4, Func Offset: 0x44
        
        pCard->cMcCheckFlag = 1; // Line 1769, Address: 0x2743f4, Func Offset: 0x54
        
        return 0x68; // Line 1771, Address: 0x2743fc, Func Offset: 0x5c
    }


    
    SaveMemoryCardSelectPortState(pCard, 1U); // Line 1776, Address: 0x274404, Func Offset: 0x64
    
    lPort0Result = GetMemoryCardSelectPortState(pCard, 0U); // Line 1778, Address: 0x274410, Func Offset: 0x70
    lPort1Result = CheckMcSelectPortInfoType(1U); // Line 1779, Address: 0x27441c, Func Offset: 0x7c
    
    SetMemoryCardSelectPortState(pCard, 1U, lPort1Result); // Line 1781, Address: 0x27442c, Func Offset: 0x8c
    
    pCard->cMcCheckFlag = 0;

    
    if (CompMemoryCardSelectPortState(pCard, 0U) == 0 && CompMemoryCardSelectPortState(pCard, 1U) == 0) // Line 1786, Address: 0x27443c, Func Offset: 0x9c
    {
        return 0x64; // Line 1788, Address: 0x274468, Func Offset: 0xc8
    }

    if (lPort0Result == 2 || lPort1Result == 2) // Line 1791, Address: 0x274470, Func Offset: 0xd0
    {
        return 0x65; // Line 1793, Address: 0x274484, Func Offset: 0xe4
    }
    
    if (lPort0Result != 2 && lPort0Result != 0 || lPort1Result != 2 && lPort1Result != 0) // Line 1796, Address: 0x274490, Func Offset: 0xf0
    {
        return 0x66; // Line 1798, Address: 0x2744b4, Func Offset: 0x114
    } 


    
    return 0x67; // Line 1803, Address: 0x2744c0, Func Offset: 0x120
...
int SetMemoryCardFreeCapacity(MEMORYCARDSTATE* pCard, int Free) {
    pCard->Port[pCard->lCurrentPort].lFreeSize = Free; // Line 1826, Address: 0x2744e0, Func Offset: 0
    return pCard->Port[pCard->lCurrentPort].lFreeSize; // Line 1829, Address: 0x2744f0, Func Offset: 0x10
...
/* 100% match */
int GetMemoryCardFreeCapacity(MEMORYCARDSTATE* pCard) { // Line 1848, Address: 0x274510, Func Offset: 0
    int lResult;


    if (pCard->ulState != 0)  // Line 1852, Address: 0x27451c, Func Offset: 0xc
    {
    
        return -2; // Line 1855, Address: 0x274528, Func Offset: 0x18
    }

    lResult = CheckMemoryCardInfoFree(pCard); // Line 1858, Address: 0x274530, Func Offset: 0x20


    if (lResult > 0)  // Line 1861, Address: 0x274538, Func Offset: 0x28
    {
        return SetMemoryCardFreeCapacity(pCard, lResult); // Line 1863, Address: 0x274540, Func Offset: 0x30
    }

    if (lResult == -1) 
    {
        return -1; // Line 1868, Address: 0x274554, Func Offset: 0x44
    }
...
int CheckMemoryCardExistFileList(MEMORYCARDSTATE* pCard, char** cppPathList, unsigned int FileCount) { 	// Line 2188, Address: 0x274720, Func Offset: 0
    ...
    lResult = GetMemoryCardDir(pCard, cEntryName, 0, FileCount + 2, &CardInfo[0]); // Line 2206, Address: 0x274784, Func Offset: 0x64
...
int MemoryCardGetSum(unsigned char* ucpTop, unsigned int ulSize) { 
    ...
    // Use a for loop to iterate over the bytes
    for (; ulSize != 0; ulSize--) // Line 2258, Address: 0x274870, Func Offset: 0
    {
        ulSum += *ucpTop++; // Line 2260, Address: 0x274878, Func Offset: 0x8
...
int GetMemoryCardSelectPortFormatType(MEMORYCARDSTATE* pCard, unsigned int ulPort) {
    return pCard->Port[ulPort].lFormatType; // Line 2285, Address: 0x2748a0, Func Offset: 0
...
/* 100% match */
int CheckMcSelectPortInfoType(unsigned int ulPort) { // Line 2395, Address: 0x2748b0, Func Offset: 0
    int lCmd, lResult, lRetry, lPortResult;

    lRetry = 5; // Line 2398, Address: 0x2748c0, Func Offset: 0x10
    while (lRetry != 0)
    {
        if (sceMcGetInfo(ulPort, 0, &lPortResult, NULL, NULL) == 0) // Line 2401, Address: 0x2748c8, Func Offset: 0x18
        {
            if (sceMcSync(0, &lCmd, &lResult) == 1) // Line 2403, Address: 0x2748e8, Func Offset: 0x38
            {
                return lPortResult; // Line 2405, Address: 0x274904, Func Offset: 0x54
            }

            
            lRetry--; // Line 2409, Address: 0x27490c, Func Offset: 0x5c
        }    
        else // Line 2411, Address: 0x274910, Func Offset: 0x60
        {

            lRetry--; // Line 2414, Address: 0x274918, Func Offset: 0x68
        } // Line 2415, Address: 0x27491c, Func Offset: 0x6c
    } // Line 2416, Address: 0x274920, Func Offset: 0x70
    
    return 0; // Line 2418, Address: 0x274928, Func Offset: 0x78
...
/* 100% match */
int CheckMemoryCardInfoFree(MEMORYCARDSTATE* pCard) { // Line 2439, Address: 0x274940, Func Offset: 0
	int lCmd, lResult, lRetry, lResultFreeCapacity;

    lRetry = 5; // Line 2442, Address: 0x274950, Func Offset: 0x10
    while (lRetry != 0)
    {
        if (sceMcGetInfo(pCard->lCurrentPort, 0, NULL, &lResultFreeCapacity, NULL) == 0) // Line 2445, Address: 0x274958, Func Offset: 0x18
        {
            if (sceMcSync(0, &lCmd, &lResult) == 1) // Line 2447, Address: 0x274978, Func Offset: 0x38
            {
                    
                if (lResult >= -2) // Line 2450, Address: 0x274994, Func Offset: 0x54
                {    
                    
                    lResultFreeCapacity -= 2;
                    
                    if(lResultFreeCapacity < 0)
                    {
                        return 0; // Line 2457, Address: 0x2749a4, Func Offset: 0x64
                    } 
                    else
                    {
                        return lResultFreeCapacity;
                    }
                }    
                ...
                return -1;    // Line 2470, Address: 0x2749c0, Func Offset: 0x80
            }


            
            lRetry--; // Line 2475, Address: 0x2749cc, Func Offset: 0x8c
        }    
        else  // Line 2477, Address: 0x2749d0, Func Offset: 0x90
        {
            
            lRetry--; // Line 2480, Address: 0x2749d8, Func Offset: 0x98
        } // Line 2481, Address: 0x2749dc, Func Offset: 0x9c
    } // Line 2482, Address: 0x2749e0, Func Offset: 0xa0
    
    return -1; // Line 2484, Address: 0x2749e8, Func Offset: 0xa8
...
/* 100% match */
int CheckMcSelectPortInfoState(unsigned int ulPort) { // Line 2501, Address: 0x274a00, Func Offset: 0
    int lCmd, lResult, lRetry, lPortResult;
    
	lRetry = 5; // Line 2504, Address: 0x274a10, Func Offset: 0x10
    while (lRetry != 0) 
    { 
        if (sceMcGetInfo(ulPort, 0, &lPortResult, NULL, NULL) == 0)  // Line 2507, Address: 0x274a18, Func Offset: 0x18
        {
            if (sceMcSync(0, &lCmd, &lResult) == 1)   // Line 2509, Address: 0x274a38, Func Offset: 0x38
            {
                if(lPortResult == 2)
                {
                    return 1;  // Line 2513, Address: 0x274a54, Func Offset: 0x54
                }
                else
                {
                    return 0;
            ...
            --lRetry; // Line 2522, Address: 0x274a78, Func Offset: 0x78
            continue; // Line 2524, Address: 0x274a7c, Func Offset: 0x7c
        }


        --lRetry; // Line 2527, Address: 0x274a84, Func Offset: 0x84

    } // Line 2529, Address: 0x274a88, Func Offset: 0x88

    return 0; // Line 2531, Address: 0x274a90, Func Offset: 0x90
...
/* 100% match */
int CheckMemoryCardInfoUnformat(MEMORYCARDSTATE* pCard) { // Line 2549, Address: 0x274ab0, Func Offset: 0
    int lCmd, lResult, lRetry, lPortFormt;

    lRetry = 5; // Line 2552, Address: 0x274ac0, Func Offset: 0x10
    while (lRetry != 0) 
    {
        if (sceMcGetInfo(pCard->lCurrentPort, 0, NULL, NULL, &lPortFormt) == 0) // Line 2555, Address: 0x274ac8, Func Offset: 0x18
        {
            if (sceMcSync(0, &lCmd, &lResult) == 1) // Line 2557, Address: 0x274ae8, Func Offset: 0x38
            {
                switch (lResult) // Line 2559, Address: 0x274b04, Func Offset: 0x54
                {
                    case 0:
                    case -1:
                    case -2:
                        return lPortFormt; // Line 2564, Address: 0x274b30, Func Offset: 0x80
                    
                    default:    
                        return -1; // Line 2567, Address: 0x274b38, Func Offset: 0x88
                }

            }


            lRetry--; // Line 2573, Address: 0x274b40, Func Offset: 0x90
        }    
        else  // Line 2575, Address: 0x274b44, Func Offset: 0x94
        {
                        
            lRetry--; // Line 2578, Address: 0x274b4c, Func Offset: 0x9c
        }
    } // Line 2580, Address: 0x274b50, Func Offset: 0xa0

    return -1; // Line 2582, Address: 0x274b58, Func Offset: 0xa8
...
/* 100% match */
int GetMemoryCardDir(MEMORYCARDSTATE* pCard, char* cpPath, int lFlag, int lMaxent, sceMcTblGetDir* pbuff) { // Line 2608, Address: 0x274b70, Func Offset: 0
    int lCmd, lResult, lRetry;
    
    lRetry = 5;  // Line 2611, Address: 0x274b90, Func Offset: 0x20
    while (lRetry != 0)  
    {
        if (sceMcGetDir(pCard->lCurrentPort, 0, cpPath, lFlag, lMaxent, pbuff) == 0)  // Line 2614, Address: 0x274ba8, Func Offset: 0x38
        {
            if (sceMcSync(0, &lCmd, &lResult) == 1) // Line 2616, Address: 0x274bcc, Func Offset: 0x5c
            {
                if (lResult >= 0)  
                {
                    return lResult;  // Line 2620, Address: 0x274be8, Func Offset: 0x78  
                }
                else
                {
                    return -1;  
            ...
            lRetry--;  // Line 2630, Address: 0x274c08, Func Offset: 0x98
            
        } // Line 2632, Address: 0x274c0c, Func Offset: 0x9c
        else
        {
            lRetry--;  // Line 2635, Address: 0x274c14, Func Offset: 0xa4
        }
    }// Line 2637, Address: 0x274c18, Func Offset: 0xa8

    return -2; // Line 2639, Address: 0x274c20, Func Offset: 0xb0
...
/* 100% match */
int ChangeMemoryCardDir(MEMORYCARDSTATE* pCard, char* cpPath, char* cpbuff) { // Line 2661, Address: 0x274c50, Func Offset: 0
    int lCmd;
    int lResult;
    int i = 5;     // Line 2664, Address: 0x274c68, Func Offset: 0x18
    loop:
    
    if (!sceMcChdir(pCard->lCurrentPort, 0, cpPath, cpbuff)) // Line 2667, Address: 0x274c78, Func Offset: 0x28
    {
        if (sceMcSync(0, &lCmd, &lResult) == 1)  // Line 2669, Address: 0x274c94, Func Offset: 0x44
        {
            
        
            return  lResult == 0 ? 1 : -1; // Line 2673, Address: 0x274cb0, Func Offset: 0x60
        ...
        i--; // Line 2682, Address: 0x274cc4, Func Offset: 0x74
        
        goto next; // Line 2684, Address: 0x274cc8, Func Offset: 0x78
    }
    
    i--; // Line 2687, Address: 0x274cd0, Func Offset: 0x80
    next: // Line 2688, Address: 0x274cd4, Func Offset: 0x84
    if (i!=0)  goto loop; // Line 2689, Address: 0x274cd8, Func Offset: 0x88
    
    return -1; // Line 2691, Address: 0x274ce0, Func Offset: 0x90
...
/* 100% match */
int MakeMemoryCardDir(MEMORYCARDSTATE* pCard) { // Line 2708, Address: 0x274d00, Func Offset: 0
    int lCmd, lResult, lRetry;

    lRetry = 5; // Line 2711, Address: 0x274d10, Func Offset: 0x10

    do {
        if (sceMcMkdir(pCard->lCurrentPort, 0, pCard->cCurrentDir) == 0) // Line 2714, Address: 0x274d18, Func Offset: 0x18    
        {
            if (sceMcSync(0, &lCmd, &lResult) == 1) // Line 2716, Address: 0x274d30, Func Offset: 0x30
            {
                if(lResult == 0) {
                    
                    return 1; // Line 2720, Address: 0x274d4c, Func Offset: 0x4c
                } else {
                    return 0;
                }
            }
            ...
            lRetry--; // Line 2729, Address: 0x274d5c, Func Offset: 0x5c
            
        } else { // Line 2731, Address: 0x274d60, Func Offset: 0x60

            
            lRetry--; // Line 2734, Address: 0x274d68, Func Offset: 0x68
        } // Line 2735, Address: 0x274d6c, Func Offset: 0x6c
    } while (lRetry != 0); // Line 2736, Address: 0x274d70, Func Offset: 0x70
        
    return 0; // Line 2738, Address: 0x274d78, Func Offset: 0x78
...
/* 100% match */
int MemoryCardFormat(MEMORYCARDSTATE* pCard) { // Line 2755, Address: 0x274d90, Func Offset: 0
    int lCmd, lResult, lSyncResult;

    switch (pCard->usMcSysState) // Line 2758, Address: 0x274d9c, Func Offset: 0xc
    {
        case 0:
            lResult = sceMcFormat(pCard->lCurrentPort, 0); // Line 2761, Address: 0x274dc0, Func Offset: 0x30
            
            if (lResult < 0) // Line 2763, Address: 0x274dd0, Func Offset: 0x40
            {
                
                if(--pCard->cRetryCount != 0)
                {
                    return 0; // Line 2768, Address: 0x274ddc, Func Offset: 0x4c
                }
                else
                {
                    return -1;
            ...
            else if (lResult == 0) // Line 2775, Address: 0x274e00, Func Offset: 0x70
            {
                pCard->usMcSysState = 1; // Line 2777, Address: 0x274e08, Func Offset: 0x78
            }
            break; // Line 2779, Address: 0x274e0c, Func Offset: 0x7c

        case 1:
            lSyncResult = sceMcSync(1, &lCmd, &lResult); // Line 2782, Address: 0x274e14, Func Offset: 0x84
            
            if (lSyncResult == 1) // Line 2784, Address: 0x274e20, Func Offset: 0x90
            {
                if (lResult < 0) // Line 2786, Address: 0x274e2c, Func Offset: 0x9c
                {
                    pCard->usMcSysState = 0;
                    
                    return -1; // Line 2790, Address: 0x274e38, Func Offset: 0xa8
                }


                
                pCard->usMcSysState = 0; // Line 2795, Address: 0x274e44, Func Offset: 0xb4
                
                return 1; // Line 2797, Address: 0x274e48, Func Offset: 0xb8
                
            }
            else if (lSyncResult == -1) // Line 2800, Address: 0x274e50, Func Offset: 0xc0
            {
                
                pCard->usMcSysState = 0; // Line 2803, Address: 0x274e5c, Func Offset: 0xcc
                return -1; // Line 2804, Address: 0x274e60, Func Offset: 0xd0
                
            }
    }

    return 0; // Line 2809, Address: 0x274e68, Func Offset: 0xd8
...
/* 100% match */
int MemoryCardUnFormat(MEMORYCARDSTATE* pCard) {
    return 0;
...
/* 100% match */
int DeleteMemoryCard(MEMORYCARDSTATE* pCard) {
    return 0;
...
/* 100% match */
int MemoryCardFileOpen(MEMORYCARDSTATE* pCard) { // Line 2918, Address: 0x274ea0, Func Offset: 0
    int lCmd, lResult, lSyncResult;

    switch (pCard->usMcSysState) // Line 2921, Address: 0x274eac, Func Offset: 0xc
    {

        case 0:

            lResult = sceMcOpen(pCard->lCurrentPort, 0, pCard->cCurrentDir, pCard->lOpenMode); // Line 2926, Address: 0x274ed0, Func Offset: 0x30
            if (lResult < 0) // Line 2927, Address: 0x274ee8, Func Offset: 0x48
            {

                if(--pCard->cRetryCount != 0)
                {
                    return 0; // Line 2932, Address: 0x274ef4, Func Offset: 0x54
                }
                else
                {
                    return -1;
            ...
            else if (lResult == 0) // Line 2939, Address: 0x274f18, Func Offset: 0x78
            {
                pCard->usMcSysState = 1; // Line 2941, Address: 0x274f20, Func Offset: 0x80
            }
            break; // Line 2943, Address: 0x274f24, Func Offset: 0x84

        case 1:
            lSyncResult = sceMcSync(1, &lCmd, &lResult); // Line 2946, Address: 0x274f2c, Func Offset: 0x8c
            if (lSyncResult == 1) // Line 2947, Address: 0x274f38, Func Offset: 0x98
            {
                if (lResult < 0)  // Line 2949, Address: 0x274f44, Func Offset: 0xa4
                {
                    pCard->usMcSysState = 0;

                    return -1; // Line 2953, Address: 0x274f50, Func Offset: 0xb0
                }



                pCard->usMcSysState = 0; // Line 2958, Address: 0x274f5c, Func Offset: 0xbc
                
                return 1; // Line 2960, Address: 0x274f60, Func Offset: 0xc0
            }



            else if (lSyncResult == -1) // Line 2965, Address: 0x274f68, Func Offset: 0xc8
            {
                pCard->usMcSysState = 0; // Line 2967, Address: 0x274f74, Func Offset: 0xd4

                return -1; // Line 2969, Address: 0x274f78, Func Offset: 0xd8
            }
            break;
    }
    return 0; // Line 2973, Address: 0x274f80, Func Offset: 0xe0
...
/* 100% match */
int MemoryCardFileClose(MEMORYCARDSTATE* pCard) { // Line 2991, Address: 0x274fa0, Func Offset: 0
    int lCmd, lResult, lSyncResult;

    switch (pCard->usMcSysState)  // Line 2994, Address: 0x274fac, Func Offset: 0xc
    {

        case 0:
            lResult = sceMcClose(pCard->lOpenFileNumber); // Line 2998, Address: 0x274fd0, Func Offset: 0x30
            
            if (lResult < 0) // Line 3000, Address: 0x274fdc, Func Offset: 0x3c
            {

                if (--pCard->cRetryCount) // Line 3003, Address: 0x274fe8, Func Offset: 0x48
                {
                    return 0; // Line 3005, Address: 0x275004, Func Offset: 0x64
                }



                pCard->ulState = 0; // Line 3010, Address: 0x275010, Func Offset: 0x70
                
                pCard->ulError = 8; // Line 3012, Address: 0x27500c, Func Offset: 0x6c
                
                pCard->cRetryCount = 5; // Line 3014, Address: 0x275018, Func Offset: 0x78
                return -1;  // Line 3015, Address: 0x275020, Func Offset: 0x80
            }

            if (lResult > 0) // Line 3018, Address: 0x275028, Func Offset: 0x88
            {
                return 0; // Line 3021, Address: 0x275030, Func Offset: 0x90
            }



            pCard->usMcSysState = 1; // Line 3025, Address: 0x275038, Func Offset: 0x98

            pCard->cRetryCount = 5; // Line 3027, Address: 0x275040, Func Offset: 0xa0

            break; // Line 3029, Address: 0x275044, Func Offset: 0xa4

        case 1:
            lSyncResult = sceMcSync(1, &lCmd, &lResult); // Line 3032, Address: 0x27504c, Func Offset: 0xac
            if (lSyncResult == 1) // Line 3033, Address: 0x275058, Func Offset: 0xb8
            {
                if (lResult < 0) // Line 3035, Address: 0x275064, Func Offset: 0xc4
                {

                    pCard->ulState = 0; // Line 3038, Address: 0x275074, Func Offset: 0xd4

                    pCard->ulError = 8; // Line 3040, Address: 0x275070, Func Offset: 0xd0

                    pCard->usMcSysState = 0; 

                    return -1; // Line 3044, Address: 0x27507c, Func Offset: 0xdc
                }



                pCard->usMcSysState = 0; // Line 3049, Address: 0x275088, Func Offset: 0xe8

                return 1;// Line 3051, Address: 0x27508c, Func Offset: 0xec
            }

            if (lSyncResult == -1)  // Line 3054, Address: 0x275094, Func Offset: 0xf4
            {

                pCard->ulState = 0; // Line 3057, Address: 0x2750a8, Func Offset: 0x108

                pCard->ulError = 8; // Line 3059, Address: 0x2750a4, Func Offset: 0x104

                pCard->usMcSysState = 0;

                return -1; // Line 3063, Address: 0x2750a0, Func Offset: 0x100
            }
    }

    return 0; // Line 3067, Address: 0x2750b8, Func Offset: 0x118
...
/* 100% match */
int MemoryCardFileRead(MEMORYCARDSTATE* pCard) { // Line 3087, Address: 0x2750d0, Func Offset: 0
    int lCmd, lResult, lSyncResult;

    switch (pCard->usMcSysState) {  // Line 3090, Address: 0x2750dc, Func Offset: 0xc

        case 0:
            lResult = sceMcRead(pCard->lOpenFileNumber, pCard->vpAddr, (int) pCard->ulFileSize); // Line 3093, Address: 0x275100, Func Offset: 0x30

            if (lResult < 0)   // Line 3095, Address: 0x275114, Func Offset: 0x44
            {

                if (--pCard->cRetryCount)  // Line 3098, Address: 0x275120, Func Offset: 0x50
                {
                    return 0; // Line 3100, Address: 0x27513c, Func Offset: 0x6c
                } 

                else 
                {
                    pCard->ulError = 1; // Line 3105, Address: 0x275148, Func Offset: 0x78

                    pCard->ulState = 0; // Line 3107, Address: 0x275144, Func Offset: 0x74

                    pCard->cRetryCount = 5; // Line 3109, Address: 0x275150, Func Offset: 0x80
                    return -1; // Line 3110, Address: 0x275158, Func Offset: 0x88
                }
            }
            if (lResult > 0) // Line 3113, Address: 0x275160, Func Offset: 0x90
            {

                return 0; // Line 3116, Address: 0x275168, Func Offset: 0x98

            }

            pCard->usMcSysState = 1; // Line 3120, Address: 0x275170, Func Offset: 0xa0
            pCard->cRetryCount = 5; // Line 3121, Address: 0x275178, Func Offset: 0xa8

            break; // Line 3123, Address: 0x27517c, Func Offset: 0xac

        case 1:
            lSyncResult = sceMcSync(1, &lCmd, &lResult); // Line 3126, Address: 0x275184, Func Offset: 0xb4
            if (lSyncResult == 1)  // Line 3127, Address: 0x275190, Func Offset: 0xc0
            {
                if (lResult < 0)  // Line 3129, Address: 0x27519c, Func Offset: 0xcc
                {

                    pCard->ulState = 0; // Line 3132, Address: 0x2751a8, Func Offset: 0xd8

                    pCard->ulError = 1; // Line 3134, Address: 0x2751ac, Func Offset: 0xdc

                    pCard->usMcSysState = 0;

                    return -1; // Line 3138, Address: 0x2751b0, Func Offset: 0xe0
                }



                pCard->usMcSysState = 0; // Line 3143, Address: 0x2751bc, Func Offset: 0xec

                return 1; // Line 3145, Address: 0x2751c0, Func Offset: 0xf0
            }

            if (lSyncResult == -1)  // Line 3148, Address: 0x2751c8, Func Offset: 0xf8
            {

                pCard->ulState = 0; // Line 3151, Address: 0x2751d4, Func Offset: 0x104

                pCard->ulError = 1; // Line 3153, Address: 0x2751d8, Func Offset: 0x108

                pCard->usMcSysState = 0; // Line 3155, Address: 0x2751dc, Func Offset: 0x10c

                return -1; // Line 3157, Address: 0x2751e0, Func Offset: 0x110
            }
    }


    return 0; // Line 3162, Address: 0x2751e8, Func Offset: 0x118
...
/* 100% match */
int MemoryCardFileWrite(MEMORYCARDSTATE* pCard) { // Line 3180, Address: 0x275200, Func Offset: 0
    int lCmd, lResult, lSyncResult;

    switch (pCard->usMcSysState) // Line 3183, Address: 0x27520c, Func Offset: 0xc
    {
        case 0:
            lResult = sceMcWrite(pCard->lOpenFileNumber, pCard->vpAddr, pCard->ulFileSize); // Line 3186, Address: 0x275230, Func Offset: 0x30

            if (lResult < 0) // Line 3188, Address: 0x275244, Func Offset: 0x44
            {

                if (--pCard->cRetryCount) // Line 3191, Address: 0x275250, Func Offset: 0x50
                {
                    return 0; // Line 3193, Address: 0x27526c, Func Offset: 0x6c
                }



                pCard->ulState = 0; // Line 3198, Address: 0x275278, Func Offset: 0x78

                pCard->ulError = 2; // Line 3200, Address: 0x275274, Func Offset: 0x74

                pCard->cRetryCount = 5; // Line 3202, Address: 0x275280, Func Offset: 0x80
                return -1; // Line 3203, Address: 0x275288, Func Offset: 0x88
            }
            
            if (lResult > 0) // Line 3206, Address: 0x275290, Func Offset: 0x90
            {

                return 0; // Line 3209, Address: 0x275298, Func Offset: 0x98
            }


            pCard->usMcSysState = 1; // Line 3213, Address: 0x2752a0, Func Offset: 0xa0

            pCard->cRetryCount = 5; // Line 3215, Address: 0x2752a8, Func Offset: 0xa8

            break; // Line 3217, Address: 0x2752ac, Func Offset: 0xac

        case 1:
            lSyncResult = sceMcSync(1, &lCmd, &lResult); // Line 3220, Address: 0x2752b4, Func Offset: 0xb4

            if (lSyncResult == 1) // Line 3222, Address: 0x2752c0, Func Offset: 0xc0
            {
                if (lResult < 0) // Line 3224, Address: 0x2752cc, Func Offset: 0xcc
                {

                    pCard->ulState = 0; // Line 3227, Address: 0x2752dc, Func Offset: 0xdc

                    pCard->ulError = 2; // Line 3229, Address: 0x2752d8, Func Offset: 0xd8

                    pCard->usMcSysState = 0;

                    return -1; // Line 3233, Address: 0x2752e4, Func Offset: 0xe4
                }



                pCard->usMcSysState = 0; // Line 3238, Address: 0x2752f0, Func Offset: 0xf0

                return 1; // Line 3240, Address: 0x2752f4, Func Offset: 0xf4
            }

            if (lSyncResult == -1) // Line 3243, Address: 0x2752fc, Func Offset: 0xfc
            { 

                pCard->ulState = 0; // Line 3246, Address: 0x275310, Func Offset: 0x110

                pCard->ulError = 2; // Line 3248, Address: 0x27530c, Func Offset: 0x10c

                pCard->usMcSysState = 0; 

                return -1; // Line 3252, Address: 0x275308, Func Offset: 0x108
            }
    }


    return 0; // Line 3257, Address: 0x275320, Func Offset: 0x120
